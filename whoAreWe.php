 	...
 	<body>
 		...
 		<div id="whorweBar">
 			<p id="sentBar" dir="rtl"> <span id="sitenameBar">TeachMe</span> - אז מה הסיפור? </p>
 		</div>
 		<!-- about us div -->
 		<div class="who" >
 			<p id="we" dir="rtl" >
 				אתר למד אותי הינו אתר למורים פרטיים שנבנה ע"י סטודנטים מאוניברסיטת בן-גוריון.
 				מקימי האתר עבדו בתור מורים פרטיים במהלך התואר.
 				האתר הוקם במטרה להקל על חיפוש מורה פרטי באינטרנט במספר אופנים:<br>
 				1. מידע מפורט על כל מורה פרטי.<br>
 				2. קלות ונוחות של החיפוש.<br>
 				אנחנו מאמינים שכל תלמיד יוכל למצוא בקלות את המורה המתאים לו 
 			.</p>
 		</div>

 		<img src="assets/img/us.jpg" id="us" alt="HTML5 Icon">
 	</body>
 	</html>